...
NGame = {
	START_DATE = "1789.1.1.12",
	END_DATE = "1900.1.1.12",
...
NDiplomacy = {
	...
	TENSION_TIME_SCALE_START_DATE = "1789.1.1.12",	-- Starting at this date, the tension values will be scaled down (will be equal to 1 before that)
